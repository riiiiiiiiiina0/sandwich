...
export const attachDividerPlus = (divider) => {
  ...
  plusBtn.className =
    'absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-6 h-6 rounded-full bg-base-200 hover:bg-base-300 text-base-content shadow border border-gray-300 flex items-center justify-center text-xs opacity-0 group-hover:opacity-100 transition-opacity duration-150 pointer-events-auto z-20';
...
export const attachEdgePlusButtons = () => {
  ...
  const makeContainer = (side) => {
    ...
    btn.className =
      'absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-7 h-7 rounded-full bg-base-200 hover:bg-base-300 text-base-content shadow border border-gray-300 flex items-center justify-center text-sm opacity-0 group-hover:opacity-100 transition-opacity duration-150';
    btn.textContent = '➕';
